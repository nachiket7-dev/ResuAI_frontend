  ...
  return (
    <div>
        ...
        <div className='flex items-center gap-2'>
            <label>
                {personalInfo.image ? (
                    <img src={typeof personalInfo.image === 'string' ? personalInfo.image : URL.createObjectURL(personalInfo.image)} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80' />
                ) : (
